This code solves a bonus question in a math set; it ultimately reaches a count of **10056959 valid grids**, giving a probability of *approximately 0.2997*. The problem is given as:
